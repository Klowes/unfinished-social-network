...
module.exports = () => {
  class utPex extends EventEmitter {
    ...
    onExtendedHandshake (handshake) {
      if (!handshake.m || !handshake.m.bitbook_ext) {
        return this.emit('warning', new Error('Peer does not support bitbook_ext'))
      }
    }
    ...
    _sendMessage () {
      ...
      // send PEX message
      this._wire.extended('bitbook_ext', {
        added: added,
        'added.f': addedFlags,
        dropped: dropped,
  ...
  utPex.prototype.name = 'bitbook_ext'
